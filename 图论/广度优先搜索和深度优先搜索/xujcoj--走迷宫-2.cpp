	...
	while (Q.size())
	{
		...
		for (int i = 0; i < 4; i++)
		{
			...
			if (Next.x >= 0 && Next.x < n && Next.y >= 0 && Next.y < m)
			{
				...
				//如果你还剩3个火箭背包，你来到此地，那你将在扛着3个火箭背包的地图做标记，标记为true
				//如果你还剩2个火箭背包，你来到此地，那你将在扛着2个火箭背包的地图做标记，标记为true

				//如果你把火箭背包使用完了，身上now.r==0,没有火箭了,你来到此地，那你将在使用火箭背包的地图做标记，标记为true
